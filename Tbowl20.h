...
class _OWLCLASS TExEdit: public TEdit
{
public:
  TExEdit(TWindow* AParent, int AnId, LPSTR AText, int X,
	  int Y, int W, int H, WORD ATextLen, BOOL Multiline,
	  PTModule AModule = NULL)
	: TEdit(AParent, AnId, AText, X,Y,W,H, ATextLen, Multiline, AModule) {};

  TExEdit(TWindow* AParent, int ResourceId, WORD ATextLen,
	  PTModule AModule = NULL)
...
class  TExCheckBox : public TControl
{
public:
...
_CLASSDEF(TDateEdit)
class  TDateEdit: public TExEdit
{
 public:                                                         
...
_CLASSDEF(TDirList)
class  TDirList : public TControl
{
public:
...
_CLASSDEF(TFileList)
class  TFileList : public TControl
{
public:
...
_CLASSDEF(TDirFile)
class  TDirFile : public TFileList
{
 public:
...
class  TDriveList : public TControl
{
public:
...
class  TFloatEdit: public TExEdit
{
public:
...
_CLASSDEF(TImprint)
class  TImprint : public TControl
{
public:
...
class  TExListBox : public TListBox
{
 public:
...
class  TExRadioButton : public TControl
{
public:
...
class  TSuperButton : public TControl
{
public:
...
_CLASSDEF(TTimeEdit)
class  TTimeEdit: public TExEdit
{
public:
  ...
  BOOL SetFormat(LPTIMEFORMAT aTimeFmt)
	...
	//GetApplication()->ExecDialog(new TResourceUpdate(this,"RRESOURCE_UPDATE",SCSDef));
...
_CLASSDEF(TViewPic)
class  TViewPic : public TControl
{
 public:
...
_CLASSDEF(TViewText)
class  TViewText : public TControl
{
public:
...
public:
  ...
  short GetData(SS_COORD Col, SS_COORD Row,string Data)
	{
     return SSGetData(HWindow, Col, Row,(LPSTR)Data.c_str());
	}
