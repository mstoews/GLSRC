/*  Project invoice
    ...
    OVERVIEW
    ========
    Source file for implementation of invoiceAboutDlg (TDialog).      
*/
...
//{{invoiceAboutDlg Implementation}}
...
invoiceAboutDlg::invoiceAboutDlg (TWindow *parent, TResId resId, TModule *module)
...
invoiceAboutDlg::~invoiceAboutDlg ()
{
    Destroy();
...
void invoiceAboutDlg::SetupWindow ()
{
