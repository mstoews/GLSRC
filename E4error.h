...
/*   #define  E4_REPORT_ROBJS  0 */
   ...
   #define  E4_INFO_SET      "Set CODE4.autoOpen to 'off'"
   ...
   #define  E4_INFO_C4C      "'CODE4.memSizeBlock' is an illegal value."
   ...
   #define  E4_RESULT_TOO    "Too many pointers"
      ...
      #define  E4_INFO_SET         "CODE4.autoOpen ausschalten"
...
/*      #define  E4_REPORT_ROBJS     "Kein Zugriff auf Informationen ber Objekt" */
      ...
      #define  E4_INFO_C4C         "'CODE4.memSizeBlock' hat einen unzul„ssigen Wert"
