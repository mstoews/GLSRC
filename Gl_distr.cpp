...
double TRptDialog::dGetOpenBalance(int lPeriod)
{
 ...
 switch (lPeriod)
  {
   case 1:  dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod1(); break;
   case 2:  dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod2(); break;
   case 3:  dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod3(); break;
   case 4:  dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod4(); break;
   case 5:  dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod5(); break;
   case 6:  dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod6(); break;
   case 7:  dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod7(); break;
   case 8:  dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod8(); break;
   case 9:  dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod9(); break;
   case 10: dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod10(); break;
   case 11: dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod11(); break;
   case 12: dOpenBalance = glaccts->dCurrbal() - glaccts->dPeriod12(); break;
