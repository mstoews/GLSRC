...
BOOL FAR PASCAL PEGetPrintDate (short printJob,
                                short FAR *year,
                                short FAR *month,
                                short FAR *day);
...
short FAR PASCAL PEGetNGroups (short printJob);
...
BOOL FAR PASCAL PEGetGroupCondition (short printJob,
                                     short sectionCode,
...
short FAR PASCAL PEGetNFormulas (short printJob);

BOOL FAR PASCAL PEGetNthFormula (short printJob,
                                 short formulaN,
...
BOOL FAR PASCAL PECheckFormula (short printJob,
                                char FAR *formulaName);
...
BOOL FAR PASCAL PECheckSelectionFormula (short printJob);
...
BOOL FAR PASCAL PECheckGroupSelectionFormula (short printJob);
...
short FAR PASCAL PEGetNParams (short printJob);         // Returns number of input parameters.

BOOL  FAR PASCAL PEGetNthParam (short printJob,         
...
BOOL  FAR PASCAL PESetNthParam (short printJob,        
                                short paramN,           // 0 indexed parameter number.
...
BOOL FAR PASCAL PEHasSavedData (short printJob,
                                BOOL FAR *hasSavedData );

BOOL FAR PASCAL PEDiscardSavedData (short printJob);
...
BOOL FAR PASCAL PEZoomPreviewWindow (short printJob,
                                     short level);
...
BOOL FAR PASCAL PEPrintControlsShowing (short printJob,
                                        BOOL FAR *controlsShowing);

BOOL FAR PASCAL PEPrintWindow (short printJob,
                               BOOL waitUntilDone);

BOOL FAR PASCAL PEExportPrintWindow (short printJob,
                                     BOOL toMail,
                                     BOOL waitUntilDone);

BOOL FAR PASCAL PENextPrintWindowMagnification (short printJob);
...
BOOL FAR PASCAL PEGetSelectedPrinter (short printJob,
...
BOOL FAR PASCAL PEGetNDetailCopies (short printJob,
...
BOOL FAR PASCAL PEGetPrintOptions (short printJob,
                                   struct PEPrintOptions FAR *options);
...
BOOL FAR PASCAL PEGetMargins (short printJob,
                              short FAR *  left,
                              short FAR *  right,
                              short FAR *  top,
                              short FAR *  bottom);
...
BOOL FAR PASCAL PEGetMinimumSectionHeight (short printJob,
                                           short sectionCode,
...
BOOL FAR PASCAL PEGetSectionFormat (short printJob,
                                    short sectionCode,
                                    struct PESectionOptions FAR *options);
...
short FAR PASCAL PEGetNLinesInSection (short printJob,
                                       short sectionCode);

BOOL FAR PASCAL PEGetLineHeight (short printJob,
                                 short sectionCode,
                                 short lineN,
                                 short FAR *height,
                                 short FAR *ascent);
...
BOOL FAR PASCAL PEGetGraphType (short printJob,
                                short sectionCode,
                                short graphN,
                                short FAR *graphType);

BOOL FAR PASCAL PEGetGraphData (short printJob,
                                short sectionCode,
                                short graphN,
                                struct PEGraphDataInfo FAR *graphDataInfo);

BOOL FAR PASCAL PEGetGraphText (short printJob,
                                short sectionCode,
                                short graphN,
                                struct PEGraphTextInfo FAR *graphTextInfo);

BOOL FAR PASCAL PEGetGraphOptions (short printJob,
                                   short sectionCode,
                                   short graphN,
                                   struct PEGraphOptions FAR *graphOptions);

BOOL FAR PASCAL PESetGraphType (short printJob,
                                short sectionCode,
                                short graphN,
                                short FAR *graphType);

BOOL FAR PASCAL PESetGraphData (short printJob,
                                short sectionCode,
                                short graphN,
                                struct PEGraphDataInfo FAR *graphDataInfo);

BOOL FAR PASCAL PESetGraphText (short printJob,
                                short sectionCode,
                                short graphN,
                                struct PEGraphTextInfo FAR *graphTextInfo);

BOOL FAR PASCAL PESetGraphOptions (short printJob,
                                   short sectionCode,
                                   short graphN,
                                   struct PEGraphOptions FAR *graphOptions);
