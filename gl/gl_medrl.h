...
#include "tlist_w.h"
#include "db_medrp.h"
_CLASSDEF(TGLMedRepList)
class TGLMedRepList : public TWindow
{
 public:
 ...
 PTListWindow List;
 Tglmedreps *glmedrp;
 TGLMedRepList(PTWindowsObject AParent, LPSTR AName,Tglmedreps *gl):TWindow (AParent, AName)
  {
   glmedrp = gl;
 ...
 virtual LPSTR GetClassName(){ return "GL_MEDRP";} 
};
#endif