...
void TGlWindow::GLDeleteBatch (RTMessage){
  GetApplication()->ExecDialog(new TGLCancelBatch(this,1043));
}
...
void TGLCancelBatch::SelectSlip (RTMessage Msg)
{
 ...
 {
  if( MessageBox(HWindow,GetString(8099),szApp,MB_ICONQUESTION | MB_YESNO) == IDYES)
   {
